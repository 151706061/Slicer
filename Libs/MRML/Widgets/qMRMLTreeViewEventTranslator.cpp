...
//      connect(treeView, SIGNAL(editNodeRequested(vtkMRMLNode*)),
//              this, SLOT(onEditNodeRequested(vtkMRMLNode*)));
...
// ----------------------------------------------------------------------------
//void qMRMLTreeViewEventTranslator::onEditNodeRequested(vtkMRMLNode* node)
//{
//  if(node)
//    {
//    emit recordEvent(this->CurrentObject, "editNodeRequested", QString::fromLatin1(node->GetID()));
//    }
//  else
//    {
//    emit recordEvent(this->CurrentObject, "editNodeRequested", "NONE");
//    }
//}
