...
vtkMRMLFiberBundleTubeDisplayNode::vtkMRMLFiberBundleTubeDisplayNode()
{
  ...
  this->ColorLinesByOrientation->SetInputConnection(this->AssignAttribute->GetOutputPort());
  ...
  this->TubeFilter->SetInputConnection(this->AssignAttribute->GetOutputPort());
...
//----------------------------------------------------------------------------
vtkPolyData* vtkMRMLFiberBundleTubeDisplayNode::GetOutputPolyData()
{
